...
def render():
    ...
    try:
        ...
        # 3) 섹터 기여 수익률 (전일 대비) — 비중에 따른 트리맵: 크기=비중, 색=기여 수익률(빨강~녹색)
        st.subheader("3) 섹터 기여 수익률 (전일 대비)")
        st.caption("타일 크기 = 섹터 비중, 색상 = 기여 수익률(빨강: 음수, 녹색: 양수)")
